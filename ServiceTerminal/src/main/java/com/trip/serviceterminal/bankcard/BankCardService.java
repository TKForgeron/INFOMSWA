...
// System.out.println(String.format("The following bank card has been
// registered: \n", BankCard.toString()));
// }
...
// @Transactional
// public void updateBankCard(Integer nfcIdPath, Integer nfcIdBody, LocalDate
// expiryDate, String iban) {
// BankCard BankCard = BankCardRepository.findBankCardByNfcId(nfcIdPath)
// .orElseThrow(() -> new IllegalStateException("BankCard uuid does not
// exist"));

// if (expiryDate != null && BankCard.getExpiryDate() != expiryDate &&
