...
public class BillingController {
    ...
    @GetMapping(path = "invoices/{uuid}")
    public PassengerRoute getUserInvoices(@PathVariable("uuid") Long uuid) {
        return billingService.getUserInvoices(uuid);
    }
